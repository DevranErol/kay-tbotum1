...
client.on("guildMemberAdd", member => {  
  const kanal = member.guild.channels.cache.find(r => r.id === "761571144155004931");
...
client.on("userUpdate", async (stg, yeni) => {
  ...
  var tagrol = "761571144192884746"; // Buraya Ekip Rolünün ID
